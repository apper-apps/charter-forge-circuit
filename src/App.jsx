  ...
  useEffect(() => {
    ...
    ApperUI.setup(client, {
      ...
      onSuccess: function (user) {
        ...
        if (user) {
          // User is authenticated - add admin role detection based on existing logic
          const enhancedUser = {
            ...user,
            role: user.role || (user.email === 'admin@admin.com' ? 'admin' : 'participant')
          };
          ...
          if (redirectPath) {
            ...
            if (!currentPath.includes('/login') && !currentPath.includes('/signup')) {
              ...
              navigate(enhancedUser.role === 'admin' ? '/admin' : '/dashboard');
            }
          } else {
            navigate(enhancedUser.role === 'admin' ? '/admin' : '/dashboard');
          }
          // Store user information in Redux
          dispatch(setUser(JSON.parse(JSON.stringify(enhancedUser))));
        } else {
