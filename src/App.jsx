  ...
  useEffect(() => {
    ...
    ApperUI.setup(client, {
      ...
      onSuccess: function (user) {
        ...
        if (user) {
          // User is authenticated - map Apper user to our user format
          const mappedUser = {
            id: user.userId,
            Id: user.userId,
            email: user.emailAddress,
            role: user.emailAddress?.includes('admin') ? 'admin' : 'participant',
          ...
          dispatch(loginSuccess(JSON.parse(JSON.stringify(mappedUser))));
        } else {
